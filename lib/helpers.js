...
_beforeEach.givenModel = function(modelName, attrs, optionalHandler) {
  ...
  afterEach(function(done) {
    if ( typeof this[modelKey] !== 'undefined' ) {
...
console.log('loopback-testing::helpers DEBUG1');
        this.http.send(payload);
console.log('loopback-testing::helpers DEBUG2');
      }
      ...
      this.http.end(function(err) {
        ...
        delete test.url;
console.log('loopback-testing::helpers DEBUG3');
        cb();
console.log('loopback-testing::helpers DEBUG4');
      });
    });
